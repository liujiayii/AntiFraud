 ...
 * 房产抵押实体类
 *
 * @ClassName: HousePropertyMortgage
 * @description
 *
 * @author lujinpeng
 * @createDate 2018年10月31日-下午1:50:46
 */
public class HousePropertyMortgage {
	...
	public String toString() {
		return "HousePropertyMortgage [id=" + id + ", entry_number=" + entry_number + ", name=" + name + ", phone="
				+ phone + ", id_number=" + id_number + ", type=" + type + ", status=" + status + ", emergency_name="
				...
				+ affirm_time + ", payment_type=" + payment_type + ", affirm_date=" + affirm_date + ", business_type="
				+ business_type + ", management=" + management + ", gender=" + gender + ", email=" + email
				...
				+ relative_contact_number + ", account_opening_time=" + account_opening_time + ", emergency_relation="
				+ emergency_relation + ", domestic_relation=" + domestic_relation + ", age=" + age + ", marital_status="
				+ marital_status + ", education=" + education + ", diploma=" + diploma + ", home_phone=" + home_phone
				+ ", mailing_address=" + mailing_address + ", home_address=" + home_address + ", business_phone_number="
				+ business_phone_number + ", permanent_residence_address=" + permanent_residence_address
				+ ", home_number=" + home_number + ", assessmens=" + assessmens + ", risk_management=" + risk_management
				+ ", enterprise_name=" + enterprise_name + ", enterprise_credit=" + enterprise_credit
