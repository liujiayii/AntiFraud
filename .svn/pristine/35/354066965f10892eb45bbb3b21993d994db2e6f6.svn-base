...
<div style="padding: 15px;">
	<div class="breadcrumb">
		...
		<div class="word">
			<span class="primary">业务报单</span> <span class="triangle"></span> <span class="secondary">房屋抵押</span>
		</div>
	</div>
	<form class="form-main layui-form form-main-4" lay-filter="example">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="home_number" autocomplete="off" class="layui-input" >
			</div>
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="spouse_identification_name" autocomplete="off" class="layui-input" >
			</div>
		</div>
		<div class="layui-form-item">
...
<script src="housingMortgage.js"></script>
