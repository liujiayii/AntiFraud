...
<div style="padding: 15px;">
	...
	<form class="layui-form form-main form-main-4" action="" style="margin-top: 20px;">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="password" name="user_pwd" lay-verify="required|password" autocomplete="off" class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">确认密码</label>
			<div class="layui-input-inline">
				<input type="password" name="user_pwd_verify" lay-verify="required|password" autocomplete="off" class="layui-input">
			</div>
		</div>
