...
<script src="./riskManagement/lib/jquery.js"></script>
<script src="./riskManagement/login/login2.js"></script>
	...
	<div class="login-main">
		<form class="layui-form login-form" lay-filter="login-form" name="frmlogin">
			...
			<div class="layui-input-inline login-input-inline">
				...
				<input type="text" name="username" id="UserName" lay-verify="required" class="layui-input login-input" lay-verType="tips"> 
			</div>
