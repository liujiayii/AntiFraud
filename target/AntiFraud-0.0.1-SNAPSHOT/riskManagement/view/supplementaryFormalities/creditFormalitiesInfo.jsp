...
<div style="padding: 15px;">
	<div class="breadcrumb">
		...
		<div class="word">
			<span class="primary">补充手续</span> <span class="triangle"></span> <span class="secondary">信用贷款</span>
		</div>
	</div>
	...
	<form class="form-main layui-form form-main-4" lay-filter="subForm">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<select name="industry_of_the_company" required lay-verify="required" lay-filter="">
					<option value="">请选择</option>
		...
		<div class="layui-form-item remark-item">
			...
			<div class="layui-input-inline">
				<textarea name="borrowing_that" autocomplete="off" class="layui-input" lay-verify="required|wordlimit" lay-verType="alert"></textarea>
			</div>
		</div>
		<div class="layui-form-item remark-item">
