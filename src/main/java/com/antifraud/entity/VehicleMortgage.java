 ...
 * 
 * 
 * @ClassName: VehicleMortgage
 * 
 * @description 车辆质押抵押表
 * 
 * @author caoyaru
 * 
 * @createDate 2018年10月8日-下午1:59:54
 */
public class VehicleMortgage {
	...
	/** 配偶姓名 */
	private String spouse_identification_name;
	/** 配偶证件号码 */
	...
	/** 评估审批额度*/
	private Double approval_amount;
	...
	public String getSpouse_identification_name() {
		return spouse_identification_name;
	}
	public void setSpouse_identification_name(String spouse_identification_name) {
		this.spouse_identification_name = spouse_identification_name;
	}
	...
	public Double getApproval_amount() {
		return approval_amount;
	}
	public void setApproval_amount(Double approval_amount) {
		this.approval_amount = approval_amount;
	}
	@Override
	public String toString() {
		return "VehicleMortgage [id=" + id + ", name=" + name + ", phone=" + phone + ", id_number=" + id_number
				+ ", type=" + type + ", status=" + status + ", emergency_name=" + emergency_name + ", emergency_phone="
				+ emergency_phone + ", emergency_id_number=" + emergency_id_number + ", apply_for_limit="
				+ apply_for_limit + ", apply_for_deadline=" + apply_for_deadline + ", purpose_of_loan="
				+ purpose_of_loan + ", user_id=" + user_id + ", create_time=" + create_time + ", remark=" + remark
				+ ", approval_limit=" + approval_limit + ", approval_deadline=" + approval_deadline + ", affirm_time="
				+ affirm_time + ", payment_type=" + payment_type + ", update_time=" + update_time + ", entry_number="
				+ entry_number + ", affirm_date=" + affirm_date + ", business_type=" + business_type + ", gender="
				+ gender + ", age=" + age + ", marital_status=" + marital_status + ", education=" + education
				+ ", diploma=" + diploma + ", home_phone=" + home_phone + ", mailing_address=" + mailing_address
				+ ", home_address=" + home_address + ", business_phone_number=" + business_phone_number
				+ ", permanent_residence_address=" + permanent_residence_address + ", email=" + email
				+ ", spouse_identification_name=" + spouse_identification_name + ", spouse_identification_number="
				+ spouse_identification_number + ", spousal_work_unit=" + spousal_work_unit + ", spouse_telephone="
				+ spouse_telephone + ", relative_contact_name=" + relative_contact_name + ", relative_contact_number="
				+ relative_contact_number + ", account_opening_time=" + account_opening_time + ", licence_plate="
				+ licence_plate + ", emergency_relation=" + emergency_relation + ", domestic_relation="
				+ domestic_relation + ", assessmens=" + assessmens + ", management=" + management + ", risk_management="
				+ risk_management + ", enterprise_name=" + enterprise_name + ", enterprise_credit=" + enterprise_credit
				+ ", enterprise_bank_no=" + enterprise_bank_no + ", customs_type=" + customs_type + ", approval_amount="
				+ approval_amount + "]";
	}
