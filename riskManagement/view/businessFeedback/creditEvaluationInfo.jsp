...
<div style="padding: 15px;" class="">
	<div class="breadcrumb">
		...
		<div class="word">
			<span class="primary">业务反馈</span> <span class="triangle"></span> <span class="secondary">信用贷款</span>
		</div>
	</div>
	<form class="layui-form form-main form-main-4" action="" lay-filter="example">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<select name="marital_status" disabled lay-verify="required" lay-filter="upload">
					<option value="">请选择</option>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<select name="education" disabled lay-verify="required" lay-filter="upload">
					<option value="">请选择</option>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<select name="diploma" disabled lay-verify="required" lay-filter="upload">
					<option value="">请选择</option>
		...
		<!-- <div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="" autocomplete="off" class="layui-input" value="" disabled>
			</div>
		</div> -->
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="spouses_name" autocomplete="off" class="layui-input" value="" disabled>
			</div>
		</div>
		<div class="layui-form-item">
...
<script src="creditEvaluation.js"></script>
<script>
