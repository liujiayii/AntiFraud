...
<div style="padding: 15px;" class="">
	<div class="breadcrumb">
		...
		<div class="word">
			<span class="primary">业务报单</span> <span class="triangle"></span> <span class="secondary">车辆抵押</span>
		</div>
	</div>
	<form class="layui-form form-main form-main-4" action="" lay-filter="example">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<select name="marital_status" disabled lay-verify="required">
					<option value="">请选择</option>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<select name="domestic_relation" required lay-verify="required" lay-filter="" disabled>
					<option value="">请选择</option>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="relative_contact_number" autocomplete="off" class="layui-input" value="" lay-verify="required" disabled>
			</div>
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<select name="emergency_relation" lay-filter="" disabled>
					<option value="">请选择</option>
					<option value="0">父子(女)</option>
					<option value="1">母子(女)</option>
					<option value="2">配偶</option>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="emergency_phone" autocomplete="off" class="layui-input" value="" disabled>
			</div>
		</div>
		<div class="layui-form-item">
